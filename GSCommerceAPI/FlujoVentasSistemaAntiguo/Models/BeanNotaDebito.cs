...
namespace CapaEntidad.Ventas
{
    public class BeanNotaDebito
    {
        ...
        public String SERIE_NRO_AUMENTO { get; set; }//NUMERO Y SERIE DE DOCUMENTO ASOCIADO
        public String COD_NOTA_DEBITO { get; set; }//TIPO DE NOTA DE CREDITO
        public String DESC_NOTA_DEBITO { get; set; }//DESCRIPCION DE NOTA DE CREDITO REFERENTE AL CODIGO
