...
namespace ServicioSunat
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="ServicioSunat.billService")]
    public interface billService
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServicioSunat.getStatusResponse> getStatusAsync(ServicioSunat.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServicioSunat.sendBillResponse> sendBillAsync(ServicioSunat.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendPack", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServicioSunat.sendPackResponse> sendPackAsync(ServicioSunat.sendPackRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServicioSunat.sendSummaryResponse> sendSummaryAsync(ServicioSunat.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public ServicioSunat.statusResponse status;
        
        public getStatusResponse()
        {
        }
        
        public getStatusResponse(ServicioSunat.statusResponse status)
        {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface billServiceChannel : ServicioSunat.billService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<ServicioSunat.billService>, ServicioSunat.billService
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicioSunat.getStatusResponse> ServicioSunat.billService.getStatusAsync(ServicioSunat.getStatusRequest request)
        {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServicioSunat.getStatusResponse> getStatusAsync(string ticket)
        {
            ServicioSunat.getStatusRequest inValue = new ServicioSunat.getStatusRequest();
            inValue.ticket = ticket;
            return ((ServicioSunat.billService)(this)).getStatusAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicioSunat.sendBillResponse> ServicioSunat.billService.sendBillAsync(ServicioSunat.sendBillRequest request)
        {
            return base.Channel.sendBillAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServicioSunat.sendBillResponse> sendBillAsync(string fileName, byte[] contentFile, string partyType)
        {
            ServicioSunat.sendBillRequest inValue = new ServicioSunat.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((ServicioSunat.billService)(this)).sendBillAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicioSunat.sendPackResponse> ServicioSunat.billService.sendPackAsync(ServicioSunat.sendPackRequest request)
        {
            return base.Channel.sendPackAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServicioSunat.sendPackResponse> sendPackAsync(string fileName, byte[] contentFile, string partyType)
        {
            ServicioSunat.sendPackRequest inValue = new ServicioSunat.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((ServicioSunat.billService)(this)).sendPackAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServicioSunat.sendSummaryResponse> ServicioSunat.billService.sendSummaryAsync(ServicioSunat.sendSummaryRequest request)
        {
            return base.Channel.sendSummaryAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServicioSunat.sendSummaryResponse> sendSummaryAsync(string fileName, byte[] contentFile, string partyType)
        {
            ServicioSunat.sendSummaryRequest inValue = new ServicioSunat.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((ServicioSunat.billService)(this)).sendSummaryAsync(inValue);
        }
